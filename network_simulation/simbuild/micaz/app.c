...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x40458490, const void *arg_0x40458614);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x4049f768) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x405e9c10), 
int (*key_eq_fn)(void *arg_0x405f5064, void *arg_0x405f51cc));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x40718958, int arg_0x40718aa4);
static double RandomUniform(void );
...
static inline bool Node__pkgValid(pack *Package);
...
#line 35
  ...
  sim_log_debug(194U, TRANSPORT_CHANNEL, "STARTING TRANSMISSION\n");
...
#line 222
{
  ...
  if ((flag == 2 || flag == 3) || flag == 4) {
      ...
      if (flag == 2) {
          sim_log_debug(204U, TRANSPORT_CHANNEL, "Received SYN! \n");
          ...
          for (i = 0; i < TransportP__maxSockets[sim_node()]; i++) {
              ...
              if (__nesc_ntoh_uint8(mySocket.src.port.nxdata) == destPort) {
                  sim_log_debug(205U, ROUTING_CHANNEL, "ATTEMPTING CONNECTION WITH CLIENT\n");
                  break;
                }
              else {
#line 261
                if (i == TransportP__maxSockets[sim_node()] - 1) {
                    sim_log_debug(206U, TRANSPORT_CHANNEL, "CONNECTION FAILED, NO SOCKET W/ PORT %d\n", destPort);
                    return FAIL;
                  }
                }
            }
          ...
          sim_log_debug(207U, TRANSPORT_CHANNEL, "Sending SYN ACK! \n");
          mySocket.state = 4;
          TransportP__activeSockets[sim_node()][mySocket.fd] = mySocket;
        ...
        if (flag == 3) {
            sim_log_debug(208U, TRANSPORT_CHANNEL, "Received SYN ACK! \n");
            ...
            sim_log_debug(209U, TRANSPORT_CHANNEL, "SENDING ACK \n");
            TransportP__Transport__makePack(&myNewMsg, TOS_NODE_ID, __nesc_ntoh_uint16(mySocket.dest.addr.nxdata), 20, 4, 0, myTCPPack, PACKET_MAX_PAYLOAD_SIZE);
            TransportP__Sender__send(myNewMsg, TransportP__RoutingTable__get(__nesc_ntoh_uint16(mySocket.dest.addr.nxdata)));
            sim_log_debug(210U, TRANSPORT_CHANNEL, "CONNECTION ESTABLISHED! \n");
            TransportP__connectFinish(mySocket);
          }
        else {
          if (flag == 4) {
              sim_log_debug(211U, TRANSPORT_CHANNEL, "GOT ACK \n");
              mySocket = TransportP__getSocket(destPort, srcPort);
              mySocket.state = 4;
    ...
    if (flag == 0 || flag == 1) {
        if (flag == 0) {
            ...
            if (__nesc_ntoh_uint8(myMsg->payload[0].nxdata) != mySocket.rcvdBuff[seq]) {
                sim_log_debug(212U, TRANSPORT_CHANNEL, "RECEIVED DATA %u\n", __nesc_ntoh_uint8(myMsg->payload[0].nxdata));
              }
            ...
            if (seq <= mySocket.largestAcceptable && seq > mySocket.lastRcvd) {
                ...
                __nesc_hton_uint8(myTCPPack->srcPort.nxdata, __nesc_ntoh_uint8(mySocket.src.port.nxdata));
                __nesc_hton_uint8(myTCPPack->destPort.nxdata, __nesc_ntoh_uint8(mySocket.dest.port.nxdata));
                TransportP__Transport__makePack(&myNewMsg, TOS_NODE_ID, __nesc_ntoh_uint16(mySocket.dest.addr.nxdata), 20, PROTOCOL_TCP, 0, myTCPPack, PACKET_MAX_PAYLOAD_SIZE);
...
#line 351
          if (flag == 1) {
              ...
              if (mySocket.ACKed[seq] == FALSE) {
                  sim_log_debug(213U, TRANSPORT_CHANNEL, "ACK: %d LAST ACK: %d\n", seq, mySocket.lastAck);
...
#line 389
      if (flag == 5 || flag == 6) {
          ...
          if (flag == 5) {
              ...
              myTCPPack = (tcp_pack *)myNewMsg.payload;
              sim_log_debug(214U, TRANSPORT_CHANNEL, "RECEIVED FIN\n");
              TransportP__Transport__close(mySocket);
            }
          else {
#line 398
            if (flag == 6) {
                ...
                TransportP__TimeoutTimer__stop();
                mySocket = TransportP__getSocket(srcPort, destPort);
                sim_log_debug(215U, TRANSPORT_CHANNEL, "RECEIVED FIN ACK\n");
                TransportP__Transport__close(mySocket);
              }
            }
        }
...
# 78 "/home/jblock/tiny/tinyos-main//tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x408d06d8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x408d06d8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x408d06d8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/jblock/tiny/tinyos-main//tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x408d0d30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x408d0d30, msg, payload, len);
#line 78
...
# 110 "/home/jblock/tiny/tinyos-main//tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x408cdc88, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x408cdc88, msg, error);
#line 110
}
#line 110
...
# 100 "/home/jblock/tiny/tinyos-main//tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x40ca6310, message_t * msg, error_t error){
#line 100
  switch (arg_0x40ca6310) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x40ca6310, msg, error);
#line 100
      break;
#line 100
    }
...
#line 78
{
  ...
  for (i = 0; i < TransportP__maxSockets[sim_node()]; i++) {
      ...
      if (__nesc_ntoh_uint8(mySocket.dest.port.nxdata) == __nesc_ntoh_uint8(server.src.port.nxdata) && server.state == 3) {
          sim_log_debug(195U, ROUTING_CHANNEL, "CLIENT FOUND\n");
...
#line 153
{
  ...
  sim_log_debug(199U, TRANSPORT_CHANNEL, "CLIENT CONNECTING...%d\n", __nesc_ntoh_uint16(mySocket.dest.addr.nxdata));
...
#line 450
{
  ...
  TransportP__activeSockets[sim_node()][fd] = mySocket;
  sim_log_debug(217U, ROUTING_CHANNEL, "CREATING CLIENT AT %d ON PORT %d\n", __nesc_ntoh_uint16(mySocket.src.addr.nxdata), __nesc_ntoh_uint8(mySocket.src.port.nxdata));
  ...
  if (!CommandHandlerP__Queue__empty()) {
      ...
      switch (commandID) {
          ...
          case CMD_TEST_SERVER: 
            sim_log_debug(175U, COMMAND_CHANNEL, "Command Type: Server\n");
...
# 75 "/home/jblock/tiny/tinyos-main//tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x407c8478){
#line 75
  switch (arg_0x407c8478) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x407c8478);
#line 75
      break;
#line 75
    }
...
#line 78
# 80 "/home/jblock/tiny/tinyos-main//tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x40ca6cac, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x40ca6cac, addr, msg, len);
#line 80
...
#line 42
  ...
  if (k == /*RoutingTableC.routingTableC*/HashmapC__1__EMPTY_KEY[sim_node()]) {
      sim_log_debug(227U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*RoutingTableC.routingTableC*/HashmapC__1__EMPTY_KEY[sim_node()]);
      return;
    }
...
#line 42
  ...
  if (k == /*NodeC.routingTableC*/HashmapC__0__EMPTY_KEY[sim_node()]) {
      sim_log_debug(188U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*NodeC.routingTableC*/HashmapC__0__EMPTY_KEY[sim_node()]);
      return;
    }
...
#line 126
{
  ...
  myTCPPack = (tcp_pack *)myMsg.payload;
  sim_log_debug(197U, TRANSPORT_CHANNEL, "READING DATA...\n");

  buff[__nesc_ntoh_uint8(myTCPPack->seq.nxdata)] = __nesc_ntoh_uint8(myTCPPack->payload[0].nxdata);
  __nesc_hton_uint8(myTCPPack->ACK.nxdata, __nesc_ntoh_uint8(myTCPPack->seq.nxdata));
  __nesc_hton_uint8(myTCPPack->flag.nxdata, 1);
  ...
  sim_log_debug(198U, TRANSPORT_CHANNEL, "%hhu\n", __nesc_ntoh_uint8(myTCPPack->ACK.nxdata));
  ...
  TransportP__Sender__send(myMsg, TransportP__RoutingTable__get(__nesc_ntoh_uint16(fd.dest.addr.nxdata)));
  bytesRead++;
...
#line 565
{
  ...
  if (!TransportP__RcvdPacketQueue__isEmpty()) {
      ...
      mySocket.lastRead = mySocket.lastRead + TransportP__Transport__read(mySocket, mySocket.rcvdBuff, SOCKET_BUFFER_SIZE);
      TransportP__activeSockets[sim_node()][mySocket.fd] = mySocket;
    }

  if (mySocket.lastRead == mySocket.transfer) {
      __nesc_hton_uint8(myTCPPack->flag.nxdata, 5);
      sim_log_debug(223U, TRANSPORT_CHANNEL, "CLIENT INITIATING TEARDOWN...\n");
...
#line 95
{
  ...
  for (i = fd.lastWritten; i < fd.transfer && i < bufflen; i++) {
      if (TransportP__SendPacketQueue__size() < 100) {
          ...
          sim_log_debug(196U, TRANSPORT_CHANNEL, "%hu\n", __nesc_ntoh_uint8(myTCPPack->seq.nxdata));
          TransportP__Transport__makePack(&myMsg, TOS_NODE_ID, __nesc_ntoh_uint16(fd.dest.addr.nxdata), 20, PROTOCOL_TCP, 0, myTCPPack, PACKET_MAX_PAYLOAD_SIZE);
...
#line 519
{
  ...
  if (__nesc_ntoh_uint8(myTCPPack->flag.nxdata) == 0) {
      sim_log_debug(219U, TRANSPORT_CHANNEL, "WINDOW: %d\n", mySocket.largestAcceptable);
      while (__nesc_ntoh_uint8(myTCPPack->seq.nxdata) < mySocket.largestAcceptable) {
...
#line 542
                if (__nesc_ntoh_uint8(myTCPPack->seq.nxdata) > mySocket.lastSent && mySocket.lastSent != mySocket.transfer) {
                    sim_log_debug(220U, TRANSPORT_CHANNEL, "SENDING...%d\n", __nesc_ntoh_uint8(myTCPPack->seq.nxdata));
...
#line 546
                  if (mySocket.ACKed[__nesc_ntoh_uint8(myTCPPack->seq.nxdata)] == FALSE) {
                      sim_log_debug(221U, TRANSPORT_CHANNEL, "TIMEOUT...RETRANSMITTING %d\n", __nesc_ntoh_uint8(myTCPPack->seq.nxdata));
                    }
                  }
                }
...
#line 556
  ...
  sim_log_debug(222U, TRANSPORT_CHANNEL, "\n");
}
...
#line 605
  ...
  myTCPPack = (tcp_pack *)myMsg.payload;
  mySocket = TransportP__getSocket(__nesc_ntoh_uint8(myTCPPack->srcPort.nxdata), __nesc_ntoh_uint8(myTCPPack->destPort.nxdata));
  sim_log_debug(224U, TRANSPORT_CHANNEL, "TIMEOUT\n");
  if (!TransportP__SendPacketQueue__isEmpty()) {
      ...
      if ((__nesc_ntoh_uint8(myTCPPack->flag.nxdata) == 2 || __nesc_ntoh_uint8(myTCPPack->flag.nxdata) == 3) || __nesc_ntoh_uint8(myTCPPack->flag.nxdata) == 4) {
          sim_log_debug(225U, TRANSPORT_CHANNEL, "RETRANSMITTING \n");
          TransportP__SendTimer__startOneShot(10);
        }
      else 
#line 615
        {
          ...
          myTCPPack = (tcp_pack *)myMsg.payload;
          mySocket = TransportP__getSocket(__nesc_ntoh_uint8(myTCPPack->srcPort.nxdata), __nesc_ntoh_uint8(myTCPPack->destPort.nxdata));
          sim_log_debug(226U, TRANSPORT_CHANNEL, "RETRANSMITTING %d\n", __nesc_ntoh_uint8(myTCPPack->seq.nxdata));
...
# 83 "/home/jblock/tiny/tinyos-main//tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x40c42ef8){
#line 83
  switch (arg_0x40c42ef8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x40c42ef8);
#line 83
      break;
#line 83
    }
...
#line 173
{
  ...
  if (fd.state == 4) {
      ...
      sim_log_debug(200U, TRANSPORT_CHANNEL, "FIN WAIT...\n");
      TransportP__SendPacketQueue__pushback(myMsg);
      TransportP__SendTimer__startOneShot(10);
    }
  else {
#line 192
    if (fd.state == 1) {
        ...
        sim_log_debug(201U, TRANSPORT_CHANNEL, "TIME WAIT...\n");
...
#line 210
          TransportP__SendPacketQueue__popfront();
          TransportP__TimeoutTimer__stop();
          sim_log_debug(202U, TRANSPORT_CHANNEL, "CONNECTION CLOSED\n");

          while (fd.rcvdBuff[i] != 0) {
              sim_log_debug(203U, TRANSPORT_CHANNEL, "DATA: %hhu \n", fd.rcvdBuff[i]);
              i++;
            }
          fd.state = 0;
          TransportP__activeSockets[sim_node()][fd.fd] = fd;
