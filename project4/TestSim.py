...
class TestSim:
    ...
    def cmdChatServer(self, address, port):
        self.sendCMD(self.CMD_CHAT_SERVER, address, port)

    def cmdHello(self, address, msg):
	print 'Sending ', msg;
	self.sendCMD(self.CMD_HELLO, address, msg);

    def cmdMsg(self, address, msg):
	print 'Sending ', msg;
	self.sendCMD(self.CMD_MSG, address, msg);

    def cmdWhisper(self, address, msg):
	print 'Sending ', msg;
	self.sendCMD(self.CMD_WHISPER, address, msg);

    def cmdPrintUsers(self, address, msg):
	print 'Sending ', msg;
	self.sendCMD(self.CMD_PRINT_USERS, address, msg);
...
def main():
    ...
    #Project 4
    s.cmdChatServer(1, "41");
    s.runTime(20);
    s.cmdHello(2, "hello jb 2\r\n");
    s.runTime(20);
    s.cmdHello(3, "hello jm 4\r\n");
    s.runTime(20);
    #s.cmdMsg(2, "msg HD!\r\n");
    #s.runTime(50);
    #s.cmdPrintUsers(1, "PrintUsers\r\n");
    #s.runTime(20);
    s.cmdWhisper(2, "whisper jblock3 hello\r\n");
    s.runTime(100);
